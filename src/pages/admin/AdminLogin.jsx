...
export default function AdminLogin({
    ...
    subtitle = 'Đăng nhập để quản lý trường',
    backTo = '/',
}) {
    ...
    const emailPlaceholder = defaultRole === 'admin' ? 'Email quản trị' : 'Email tài khoản'
    ...
    return (
        <div
            style={{
                minHeight: '100vh',
                background: 'linear-gradient(135deg,#1E1B4B 0%,#2D2870 50%,#4C1D95 100%)',
                display: 'flex',
                alignItems: 'center',
