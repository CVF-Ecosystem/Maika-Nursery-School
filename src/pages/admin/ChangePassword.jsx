    ...
    return (
        <div
            style={{
                position: 'fixed',
                inset: 0,
                background: forced ? 'rgba(30,27,75,0.85)' : 'rgba(0,0,0,0.4)',
                zIndex: 2000,
                display: 'flex',
                alignItems: 'center',
        ...
        >
            ...
            >
                {!forced && <ModalCloseButton onClick={() => onSuccess?.()} />}
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                    <div>
                        <label style={ls} htmlFor="cp-current">
                            Mật khẩu hiện tại *
                        </label>
                        <input
                            id="cp-current"
                    ...
                    <div>
                        ...
                        {form.newPassword.length > 0 && form.newPassword.length < 6 && (
                            <div style={{ fontSize: 11, color: '#DC2626', marginTop: 4 }}>
                                Cần thêm {6 - form.newPassword.length} ký tự nữa
                            </div>
                        )}
                    </div>
                    <div>
                        <label style={ls} htmlFor="cp-confirm">
                    ...
                    <div style={{ display: 'flex', gap: 10, marginTop: 4 }}>
                        ...
                        <button
                            type="submit"
                            disabled={
                                loading || form.newPassword.length < 6 || form.newPassword !== form.confirmPassword
                            }
                            style={{
                                flex: 2,
                                padding: '11px',
