            ...
            <main style={{ minHeight: '100vh', display: 'grid', placeItems: 'center', background: '#F5F3FF', padding: 24 }}>
                <section style={{ width: 'min(520px, 100%)', background: '#fff', borderRadius: 16, padding: 28, boxShadow: '0 18px 48px rgba(109,40,217,0.16)', textAlign: 'center' }}>
                    ...
                    {!import.meta.env.PROD && (
                        <pre style={{ margin: '0 0 16px', background: '#FEF2F2', borderRadius: 8, padding: '10px 14px', fontSize: 12, color: '#991B1B', textAlign: 'left', overflowX: 'auto', whiteSpace: 'pre-wrap', wordBreak: 'break-word' }}>
                            {msg}
                        </pre>
                    )}
                    <div style={{ display: 'flex', gap: 10, justifyContent: 'center', flexWrap: 'wrap' }}>
                        ...
                        <a href="/" style={{ display: 'inline-flex', alignItems: 'center', borderRadius: 12, padding: '11px 18px', background: '#EDE9FE', color: '#6D28D9', fontWeight: 900, textDecoration: 'none' }}>
                            Về trang chủ
                        </a>
                        <a href="mailto:info@maika.edu.vn" style={{ display: 'inline-flex', alignItems: 'center', borderRadius: 12, padding: '11px 18px', background: '#F3F4F6', color: '#374151', fontWeight: 900, textDecoration: 'none' }}>
                            Báo lỗi
                        </a>
                    </div>
                </section>
