...
2. Nhập email quản trị `admin@maika.edu.vn` và mật khẩu được cấp.
...
Xem nhanh số học sinh, giáo viên, tình hình điểm danh, thông báo và các chỉ số vận hành chính.
...
Theo dõi chuyên cần theo ngày, bao gồm có mặt, đi trễ, vắng mặt, giờ đón và ghi chú.
...
Ghi nhận sự cố, mức độ, cách xử lý ban đầu và trạng thái xác nhận từ phụ huynh.

### Học Phí / Hóa Đơn

Tạo và theo dõi hóa đơn, hạn thanh toán, trạng thái đã thanh toán hoặc quá hạn.

### Thông Báo

Tạo thông báo gửi cho phụ huynh theo vai trò, lớp, học sinh hoặc toàn trường.

### Thực Đơn

Lập thực đơn theo tuần, nhập món ăn, nguyên liệu, ghi chú dị ứng và xuất bản cho phụ huynh.

### Thư Viện Ảnh

Tạo album, tải ảnh hoạt động, duyệt trạng thái và xuất bản ảnh cho phụ huynh xem.

Ảnh không còn cần hiển thị có thể chuyển sang trạng thái lưu trữ. Admin có thể tải ảnh lưu trữ về máy và xóa khỏi Supabase trong mục Lưu trữ.
...
Theo dõi dung lượng ảnh trên Supabase, tải ảnh lưu trữ về máy và xóa khỏi Supabase khi không còn cần dùng trực tuyến.
...
- Ghi nhận nhật ký ngày, bữa ăn, giấc ngủ và ghi chú.
- Tải ảnh hoạt động lên thư viện ảnh.
