...
- [ ] Lưu cấu hình học phí và quy tắc tính phí vào DB.
- [ ] Lưu tiền thừa/credit vào DB, không dùng localStorage.
- [ ] Thêm `attendance.absence_type`.
- [ ] Preview + confirm trước khi tạo khoản thu hàng loạt.
- [ ] Cảnh báo tổng khi tháng chưa điểm danh đủ.
- [ ] Format số tiền dễ đọc trong input và bảng.

#### Tier 1 — Nên làm sớm sau Tier 0

- [ ] Cấu hình học phí theo lớp/cấp học/cơ sở.
- [ ] Cho phép override học phí theo học sinh.
- [ ] Cơ chế update hoặc tạo điều chỉnh nếu khoản thu tháng đã tồn tại.
- [ ] Sticky cột tên học sinh trong bảng điểm danh tháng.
- [ ] Thu gọn giải thích/quy ước bằng tooltip hoặc help text ngắn.

#### Tier 2 — Module mới / roadmap

- [ ] Danh mục khoản thu preset.
- [ ] Phiếu thông báo thu có line-items.
- [ ] PDF/in hàng loạt.
