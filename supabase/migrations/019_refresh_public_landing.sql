-- Ensure get_public_landing RPC is up-to-date and robust.
-- Re-creates the function so production deployments have the latest version.
...
declare
  ...
  teacher_label text;
begin
  -- Resolve facility_id only if a code was provided and facilities table exists
  begin
  ...
  -- Minimum 3 classes to avoid empty-looking landing page before setup
